...
def create_mixed_data():
    ...
    # 1. Clean Data (34 rows)
    # Shuffle real data to get random samples logic?
    clean_df = df.sample(n=34, random_state=42)
    
    # 2. Poison Data (66 rows)
    ...
    poison_data = np.random.normal(loc=100, scale=50, size=(66, features_count))
    ...
    output_path = "mixed_data_34_66.csv"
